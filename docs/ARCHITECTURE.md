...
| Application    | `src/application`                | `parsePreviewPayload`, `studioReducer` (select, edit, reset, device, mode), `studioModes`, `buildDiagnostics`, `mergeFields`, `visual/` (`documentToTsx`, `tsxPrinter`, `convertedVersion`), `repositories/` (ports: `TemplateRepository` and its result types)                                                                                                                                                                                                                                                                                                                                                                                                        | React, DOM, Zod                                  |
