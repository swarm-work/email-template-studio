...
Decisions 25 onwards (Cloudflare Access, Rate Limiting binding, Worker Loaders) are proposed in `docs/PLAN.md` section 1 and get a numbered record here when the phase that uses them lands. ADR-18 belongs to the visual-editor package choice and lands with it; the JSON Schema props contract is part of ADR-19.
